...
?>
<head>
    <title>Rise Bright student - School of Excellence</title>
</head>
...
<main>
        ...
        if($mysql_connection -> connect_error)
        {
            ...
            $sql_to_select_data = "select stuname from studentdetails where stuid='".$stuid."'";
        ...
        <h1 class="text-center" style="margin-top: 1rem;"><?= "Welcome $stuname !" ?> </h1> 
